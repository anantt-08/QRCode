...
class UserModal extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            occupation: JSON.parse(localStorage.getItem('user')).occupation,
                                        ...
                                        <div className="col-sm-6" >
                                         ...
                                         <div className="col-sm-6" >
                                            <div className="form-group">
                                                ...
                                                <input type="text" className="form-control" name="occupation" value={this.state.occupation} onChange={this.handleInput} placeholder="Occupation" />
                                            </div>
                                        </div>
                                        <div className="col-sm-6" >
                                            <div className="form-group">
